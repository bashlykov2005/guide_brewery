...
class Route(models.Model):
    ...
    city_desc = models.TextField(
        max_length=10000, blank=True, null=True, verbose_name="Описание города"
    )
    city_desc_2 = models.TextField(
        max_length=10000, blank=True, null=True, verbose_name="Описание города 2"
    )
    route_desc = models.TextField(
        max_length=50000, blank=True, null=True, verbose_name="Описание маршрута"
    )
    ...
    sort_order = models.IntegerField(
        ...
        null=True,
        default=None,
        db_index=True,  # Для ускорения сортировки
    )
